...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  console.log("balance",account, balance,alreadyStaked)
  ...
  console.log("aa", balanceFormatted,totalBalanceFormatted, tokenDetails.decimals)
  ...
  async function displayData() {
    ...
    const newBorrowAmount = await registryContract.methods.calculateRestake(account, stakeAmount * 10 ** tokenDetails.decimals).call();
    const newBorrowAmountFormatted = (newBorrowAmount / 10 ** 18).toFixed(5);
  ...
  stakeExecuteButton.addEventListener("click", async function (event) {
    ...
    const stakeAmount = parseFloat(stakeInput.value) * 10 ** tokenDetails.decimals;
