...
const cdtMainABI = [
    ...
    {
      "inputs": [],
      "name": "getAllTokenRegistryEntries",
      "outputs": [
        {
          "internalType": "address[]",
          "name": "",
  ...
  document.addEventListener('DOMContentLoaded', async function () {
    ...
    const cdtMainAddress = window.cdtMainAddress

    const registerExecuteButton = document.getElementById("register-execute-button");

    const tokenInput = document.getElementById("token-input");
    const tokenAddressDisplay = document.getElementById("token-address-display");
    
    // Add event listener to update the display with the entered address
    tokenInput.addEventListener("input", () => {
      let tokenAddress = tokenInput.value.trim();
    //  tokenAddressDisplay.innerText = tokenAddress || "Enter token address...";
    });
  
  
  
    registerExecuteButton.addEventListener("click", async function () {
      ...
      try {
        ...
        const receipt = await cdtMainContract.methods.registerToken(tokenAddress).send({ from: account });
    ...
    console.log("scriptsRegister.js DONE");
  });    