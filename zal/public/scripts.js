...
const web3_1 = new Web3('https://eth-sepolia.g.alchemy.com/v2/A8ptSp7H8vI8hdsW0SULkl5u6x8dXSCA');

      for (const tokenAddress in tokenInfos) {

        console.log("Token address in balances:",connectedAddress, tokenAddress);
        const tokenContract = new web3_1.eth.Contract(ERC20ABI, tokenAddress);
          ...
          //HARDCODED DECIMALS !!!
            ...
            listItem.innerHTML = `
              ...
              <span class="token-details-container">
                  ...
                  <span class="token-balance1">${balance }</span>
              </span>
              `;
      ...
      const userFundsEligibleForStake = userFundsEligible * 0.9;
      const fundsText = userFundsEligible + " (" +  userFundsEligibleForStake + ") WEI";
